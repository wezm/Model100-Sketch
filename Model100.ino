...
// Support for indicating active modifiers via LED
...
static kaleidoscope::plugin::LEDSolidColor solidWhite(130, 130, 130);
...
void setup() {
  ...
  // We configure the AlphaSquare effect to use Violet letters
  AlphaSquare.color = CRGB(130, 0, 120);
